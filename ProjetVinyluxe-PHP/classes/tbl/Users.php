...
include_once './lib/db/Database.php';
include_once './lib/sess/Session.php';
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
  ...
  <strong>Error !</strong> Email did not Found, use Register email or password please !</div>';
    ...
    <strong>Error !</strong> Sorry, Your account is Diactivated, Contact with Admin !</div>';
          ...
          \lib\sess\Session::init();
          \lib\sess\Session::set('login', true);
          \lib\sess\Session::set('id', $logResult->id);
          \lib\sess\Session::set('roleid', $logResult->roleid);
          \lib\sess\Session::set('name', $logResult->name);
          \lib\sess\Session::set('email', $logResult->email);
          \lib\sess\Session::set('username', $logResult->username);
          \lib\sess\Session::set('logMsg', '<div class="alert alert-success alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Success !</strong> You are Logged In Successfully !</div>');
    
          header('Location: /stud_project/index_backend.php');
