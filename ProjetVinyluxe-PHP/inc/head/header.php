...
// spl_autoload_register(function($classes,$lib){

//   include 'classes/'.$classes.".php";
//   include 'lib/'.$lib."Database.php";
 ...
 ?>
    ...
    <div class="container">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-dark card-header">
        <a class="navbar-brand" href="index.php"><i class="fas fa-home mr-2"></i>VinyLuxe</a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          ...
          <?php if (\lib\sess\Session::get('id') == TRUE) { ?>
            ...
            ">
              ...
              <a class="nav-link" href="profile.php?id=<?php echo \lib\sess\Session::get("id"); ?>"><i class="fab fa-500px mr-2"></i>Profile <span class="sr-only">(current)</span></a>
            </li>
