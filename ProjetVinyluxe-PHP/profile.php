<?php
include 'inc/head/header.php';
\lib\sess\Session::CheckSession();
include_once 'classes/tbl/Users.php';

$users = new \classes\tbl\Users();
    ...
    if ($getUinfo) {
     ...
     ?>
          ...
          <form class="" action="" method="POST">
              ...
              <div class="form-group
              <?php if (\lib\sess\Session::get("roleid") == '1' && \lib\sess\Session::get("id") == $getUinfo->id) {
                echo "d-none";
              } ?>
              ">
                <div class="form-group">
          ...
          <?php } ?>
              ...
              <?php if (\lib\sess\Session::get("id") == $getUinfo->id) {?>
            ...
            <?php } elseif(\lib\sess\Session::get("roleid") == '1') {?>
